...
<head>
    ...
    ?>
        ...
        <div class="navbar">
            <div class="logo">
                <a href="../file/home.php"><img src="../images/logo1.png" width="45px"></a>
                </div>
                <nav> 
                    <ul id="MenuItems">
        ...
        <?php
            $select_product = mysqli_query($con, "SELECT * FROM products where id = 14;") or die('query failed');
                ...
                <div class="row">
                    ...
                    <form method="post">
                        ...
                        <option>Select Size</option> 
                            <option value="Extra Large: 64mm and up">Extra Large: 64mm and up</option> 
                            <option value="Large: 58mm to 63mm">Large: 58mm to 63mm</option> 
                            <option value="Regular: 55mm to 57mm">Regular: 55mm to 57mm</option> 
                            <option value="Small: 49mm to 54mm">Small: 49mm to 54mm </option> 
                        </select>
